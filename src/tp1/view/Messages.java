...
import tp1.logic.gameobjects.NormalLaser;
...
public class Messages {
	...
	public static final String ALLOWED_LASER_MOVES = "<%s>".formatted(NormalLaser.allowedMoves("|"));
	...
	public static final String COMMAND_INCORRECT_PARAMETER_USAGE = "Incorrect parameter usage";
	...
	public static final String SHOCKWAVE_UNAVAILABLE = "You don't have a ShockWave";

	public static final String MOVEMENT_ERROR = "Movement cannot be performed";

	public static final String DIRECTION_ERROR = "Wrong direction: %s";
	...
	public static final String EXPLOSIVE_SYMBOL = "-**-";

	public static final String BOMB_SYMBOL = "*";

	public static final String UP_LASER_SYMBOL = "oo";
	public static final String LUP_LASER_SYMBOL = "<o";
	public static final String RUP_LASER_SYMBOL = "o>";
	...
	public static final String ZOMBIE_ALIEN_SYMBOL = "Z";

	public static final String ZOMBIE_ALIEN_DESCRIPTION = "[Z]ombie Alien";
	...
	public static final String COMMAND_DESCRIPTION = "%s : %s";
	...
	public static final String COMMAND_SHOOT_DETAILS = "[s]hoot " + ALLOWED_LASER_MOVES;
	...
	public static final String ALLOWED_LASER_MOVES_MESSAGE = "Allowed Laser moves: " + ALLOWED_LASER_MOVES;
	public static final String INCORRECT_MOVE_MESSAGE = "\"%s\" is not a valid direction";
	...
	public static final String commandDescription(String details, String description){
		return Messages.COMMAND_DESCRIPTION.formatted(details, description);
	}
